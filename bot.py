    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Updates Channel", url="https://t.me/sitaratoons")
                    ],
                    [
                    ...
                    [
                        InlineKeyboardButton("Support Group", url="https://t.me/Sitaratoons_chat"),
                        InlineKeyboardButton("YouTube Channel", url="https://youtube.com/@sitaratoons-01?si=gkw52Zuh7bAChP2N")
                    ]
                ]
            )
        )
